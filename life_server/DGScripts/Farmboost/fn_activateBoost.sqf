...
if(!isNil "_boost") then {
    ...
    switch (_type) do {
        case 'money': {
            ...
            ['Hinweis: Farmboost wurde aktiviert','warning',30] remoteExec ['CLIENT_fnc_hint', civilian];
        };
        case 'process': {
            dg_farmboost_active  = 1;
    ...
    publicVariable "dg_farmboost_active";
    publicVariable "dg_moneyMultiplier";
    publicVariable "dg_processMultiplier";
    publicVariable "dg_amountMultiplier";
    publicVariable "dg_xpMultiplier";
};
